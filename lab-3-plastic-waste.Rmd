...
```
Answer:the africa is the most density continent and the south USA is the most continent in plastic wate per cap.
...
Answer here: Because here we represent a set of data (continents),not just color control,as the colors here belong to the continents,and also the filling is related to the continents, but  the alpha it's talking about all Graphic (geom_density)
...
Answer: Europe (positive)relationship,Africa is the most (mismanaged plastic waste per cap) 
...
```{r plastic_waste_per_cap-total-population}
ggplot(data = plastic_waste,
...
Answer:Asia is one of the countries that has a large population, but the waste of people in it is not comparable to other countries.
...
Coastal cities in Asia and North America are among the most losing plastic cities, although they are less densely populated.
