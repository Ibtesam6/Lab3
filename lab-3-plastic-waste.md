...
Answer:the africa is the most density continent and the south USA is the
most continent in plastic wate per cap.
...
+                    y = plastic_waste_per_cap)) +     geom_point()
```
